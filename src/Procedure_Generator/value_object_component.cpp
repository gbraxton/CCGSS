...
ValueObjectComponent::ValueObjectComponent(const char *name) : GameEntityComponent(name), value(0) {}

int ValueObjectComponent::getValue() { return value; }

void ValueObjectComponent::setValue(int val) { value = val; }
