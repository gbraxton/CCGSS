...
#ifndef CARDS_OBJECT_COMPONENT_HPP_
#define CARDS_OBJECT_COMPONENT_HPP_
...
class CardsObjectComponent : public GameEntityComponent {
public:
  CardsObjectComponent(const char *name);
...
#endif /* CARDS_OBJECT_COMPONENT_HPP_ */
