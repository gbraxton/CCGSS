...
#ifndef GAME_ENTITY_COMPONENT_HPP_
#define GAME_ENTITY_COMPONENT_HPP_

class GameEntityComponent {
public:
  GameEntityComponent(const char* name);
...
#endif /* GAME_ENTITY_COMPONENT_HPP_ */
