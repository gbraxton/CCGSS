...
GameEntity::GameEntity(const char *entityName, const std::list<std::pair<const char*, const char*> > *attrs)
  : entityName(entityName), entityAttrs(attrs) {}

GameEntity::~GameEntity() {}

const char *GameEntity::getEntityName() {
  return entityName;
}
