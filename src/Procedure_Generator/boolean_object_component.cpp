...
BooleanObjectComponent::BooleanObjectComponent(const char *name)
  : GameEntityComponent(name), value(false) {}

bool BooleanObjectComponent::getValue() { return value; }

void BooleanObjectComponent::setTrue() { value = true; }
